...
})->throws(InvalidShippingConfigurationException::class, 'Shipping configuration for type "STEPS" has no levels defined');
...
it('logs warning and returns zero when no level matches', function () {
    ...
    $this->logger->shouldReceive('warning')
        ->once()
        ->with('No matching level found for STEPS shipping', \Mockery::type('array'));
