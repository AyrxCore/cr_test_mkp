<template>
  <div
    :class="[
      '[&_h1]:mb-4 [&_h2]:mb-4 [&_h3]:mb-3 [&_ol]:mb-3 [&_p]:mb-3 [&_ul]:mb-3 [&_ol]:list-decimal [&_ol]:pl-5',
      withCheckmarks
        ? 'with-checkmarks [&_ul]:list-none [&_ul]:pl-0'
...
<style scoped>
.with-checkmarks :deep(ul li) {
  position: relative;
  padding-left: 1.5rem;
}

.with-checkmarks :deep(ul li::before) {
  content: '';
  position: absolute;
  left: 0;
  top: 0.375rem;
