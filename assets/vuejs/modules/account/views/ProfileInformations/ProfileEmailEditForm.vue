...
import ChangeEmailConfirmationModal from
      '@/vuejs/modules/account/views/ProfileInformations/ChangeEmailConfirmationModal.vue'
import ChangeEmailResultModal from
      '@/vuejs/modules/account/views/ProfileInformations/ChangeEmailResultModal.vue'
