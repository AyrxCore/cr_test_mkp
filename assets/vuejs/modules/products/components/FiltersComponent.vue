<template>
  <DropdownListComponent
    class="c-scrollbar !rounded-l-md lg:h-auto lg:overflow-y-auto lg:p-0"
  >
    <template #button-label> Filtres</template>
    <template #content>
      <div v-if="props.filters" class="bg-white px-7.5">
        <div v-if="companies.length > 0" class="mb-1 bg-white pt-2">
          <h3 class="text-base font-bold uppercase text-primary md:text-lg">
        ...
        <div v-if="categories.length > 0" class="bg-white pt-2">
          <h3 class="text-base font-bold uppercase text-primary md:text-lg">
        ...
        <div v-if="filters.properties" class="mt-3">
          <h3 class="text-base font-bold uppercase text-primary md:text-lg">
            Propriétés
          </h3>
          <div
