...
class DefaultController extends AbstractController implements ChannelAwareControllerInterface
{
    ...
    #[Route(
        '/{route}',
        name: 'app',
        requirements: ['route' => '^(?!.*_wdt|_profiler|login|conditions-generales-d-utilisation|mentions-legales|politique-de-confidentialite|rattachement-stellantis|rattachement-newsletter|maintenance|api|uppler-webhook).+']
    )]
