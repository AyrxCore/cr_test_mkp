 ...
 */
final class Version20250313144509 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE adherent DROP reducce_code');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE adherent ADD reducce_code VARCHAR(255) DEFAULT NULL');
